...
public class KeyPath {
  ...
  /**
   * Parses a keypath into a byte array and source parameter to be used with the SatochipCommandSet object.
   *
  ...
  public KeyPath(String keypath) {
    ...
    switch(sourceOrFirstElement) {
      case "m":
        source = SatochipCommandSet.DERIVE_P1_SOURCE_MASTER;
        break;
      case "..":
        source = SatochipCommandSet.DERIVE_P1_SOURCE_PARENT;
        break;
      case ".":
        source = SatochipCommandSet.DERIVE_P1_SOURCE_CURRENT;
        break;
      default:
        source = SatochipCommandSet.DERIVE_P1_SOURCE_CURRENT;
  ...
  public KeyPath(byte[] data) {
    this(data, SatochipCommandSet.DERIVE_P1_SOURCE_MASTER);
  }
  ...
  public String toString() {
    ...
    switch(source) {
      case SatochipCommandSet.DERIVE_P1_SOURCE_MASTER:
        sb.append('m');
        break;
      case SatochipCommandSet.DERIVE_P1_SOURCE_PARENT:
        sb.append("..");
        break;
      case SatochipCommandSet.DERIVE_P1_SOURCE_CURRENT:
        sb.append('.');
        break;
    }
